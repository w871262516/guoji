	  	...
	  	<div class="page-content">
		  	...
		  	<list class="list-ios item-icon-right">
				<item v-for="(data,index) in myAllAddressList" :key="index">
					<router-link :to="{path:path,query:{addressData:data,total_left:total_left}}" class="section">
						<div>
							<span>{{data.name}}</span>
	...
	export default{
		...
		created(){
			if(this.$route.query.gid){
				...
				this.path = '/mine/integrationExchange/integrationMall/integrationPay'
			}
